...
import { Mountain, Zap, MapPin, Wrench } from "lucide-react";
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                                Discover premium bicycles and accessories designed for every adventure. From city commutes
                                to mountain trails, we have everything you need.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    ...
                                    className="bg-black text-white px-8 py-4 text-lg font-semibold rounded-lg hover:bg-gray-800 transition-colors flex items-center justify-center space-x-2"
                                >
                                    <span>Shop Now</span>
